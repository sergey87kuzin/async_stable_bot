INFO_TEXT = """
<pre>✅ Чтобы начать генерацию, просто отправьте боту сообщение, что вы хотите увидеть на сгенерированном изображении\n
▪️Бот рисует в нейросети StableDiffusion, Flux\n\n
...
Примеры промптов в уроках 7 и 10 на сайте и в блоге\n
...
▪️ 9. После генерации вам придёт 4 изображения \n
...
▪️ 11. Промпт созданного изображения можно отправить повторно для новой генерации, нажав на кнопку под изображением(🔄), изображение создастся в последнем выбранном стиле и формате\n
...
Например: 2000 х 2000 px (это 4Мр) или 3000 х 2000 px (это 6Мр), рекомендуем использовать для увеличения программу Topaz Gigapixel. Программа увеличивает качественнее всего и в ней можно увеличивать пакетно\n
▪️ 14. Можно увеличивать изображения в боте кнопкой 4️⃣х, нейросеть каждый раз перерисовывает изображения заново. Могут появиться изменения. \n
▪️1 увеличение = 1 генерация \n
⚠️Увеличенное изображение по ссылке доступно 10 дней. \n
▪️ 15. Неувеличенные созданные изображения из бота не пропадают, сохранить на устройство вы сможете в любое время.\n
...
PRESET_INFO_TEXT = """
<pre>▪️По умолчанию изображения создаются квадратными 1:1 \n
...
STYLE_INFO_TEXT = """
<pre>▪️По умолчанию изображения создаются без определенного стиля, чаще всего, похожими на фотографии\n
...
MENU_INFORMATION_TEXT = """
<pre>▪️Бот рисует в нейросети StableDiffusion, Flux\n
...
SUPPORT_TEXT = """
<pre>❌Техподдержка не помогает продавать работы на фотобанках, для этого переходите в Меню - Уроки\n
✅По всем техническим вопросам пишите:</pre>
"""

PASSWORD_TEXT = """
<pre>▪️Чтобы смотреть купленные уроки или купить курс, нужно авторизоваться на сайте\n
...
PAYMENT_TEXT = """
<pre>✅Для оплаты генераций или покупки курса, нужно авторизоваться на сайте\n
...
REFERRAL_TEXT = """
▪️Делитесь вашей индивидуальной ссылкой на бота! Каждый раз при оплате по вашей ссылке вам будут добавляться бессрочные генерации. 10% от оплаченных человеком генераций - ваши. И вы сможете творить бесплатно! \n
💡 Чтобы скопировать реферальную ссылку, нажмите на нее: \n
🔗 Ссылка: `https://t.me/@ToMidjourneyBot?start={chat_id}` \n
"""
